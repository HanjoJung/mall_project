...
<link href="/mall_project/css/common.css" rel="stylesheet"
	type="text/css">
<link href="/mall_project/css/common_nike.css" rel="stylesheet"
	type="text/css">
<body data-device="pc">
	<header class="container-fluid header_layout_1">
		<div class="row header-gnb">
			<div class="col-lg-12 uk-clearfix header-gnb_maxwidth">
				<ul class="uk-float-left header-brand">
					<li><a href="#"><span>Nike</span></a></li>
					<li><a
						href="https://www.nike.com/us/en_us/e/nike-plus-membership"
						target="_blank"><span>Nike+</span></a></li>
					<li><a href="#"><span class="ns-jordan"></span></a></li>
					<li><a
						href="https://www.converse.co.kr/landing/nike?tracking=pc_brandbar_04"
						target="_blank"><span class="ns-logo-converse"></span></a></li>
				</ul>
		...
		<article class="row contents">
			<nav class="col-lg-12 header-lnb">
				...
				<ul class="header-menu_onedepth" data-module-gnb="{type:type1}">
					<li class="onedepth-list"><a href="/kr/ko_kr/l/men"
						data-click-area="GNB" data-click-name="MEN" class="">MEN</a>
									...
									<ul class="header-menu_threedepth">
										...
										<li><a
											...
											data-click-area="GNB_feature" data-click-name="SB x NBA 컬렉션">SB
												x NBA 컬렉션</a></li>
										<li><a
											href="https://www.nike.com/kr/ko_kr/w/men/xb/xc/90s-style"
										...
										<ul class="header-menu_threedepth">
											...
											<li class="threedepth-list"><a
												...
												data-click-area="GNB" data-click-name="BOYS_의류_후디 &amp; 크루">후디
													&amp; 크루</a></li>
											<li class="threedepth-list"><a
												href="/kr/ko_kr/w/boys/ap/pants-tights"
												data-click-area="GNB" data-click-name="BOYS_의류_팬츠 &amp; 타이츠">팬츠
													&amp; 타이츠</a></li>
											<li class="threedepth-list"><a
								...
								<ul class="twodepth-submenu-t2">
									<li class="twodepth-list"><a href="/kr/ko_kr/w/girls/ap"
										...
										<ul class="header-menu_threedepth">
											...
											<li class="threedepth-list"><a
												href="/kr/ko_kr/w/girls/ap/top-tshirts"
												data-click-area="GNB" data-click-name="GIRLS_의류_탑 &amp; 티셔츠">탑
													&amp; 티셔츠</a></li>
											<li class="threedepth-list"><a
				...
				<div class="header-menu_etc">
					...
					<a icon-text-attr="0" data-click-area="Upper GNB"
						...
						href="/kr/ko_kr/cart" class="mini-cart empty"><i
						class="ns-cart large"></i> <!----></a>
				</div>
...
<header class="header_layout_1">
	...
	<article class="contents">
		<nav class="header-lnb">
			<a class="header-logo" href="/kr/ko_kr/"> <span class="ns-swoosh"></span>
			</a>
			<ul class="header-menu_onedepth" data-module-gnb="{type:type1}">
				<li class="onedepth-list"><a href="/kr/ko_kr/l/men"
					data-click-area="GNB" data-click-name="MEN" class="">MEN</a>
									...
									<ul class="header-menu_threedepth">
										<li class="threedepth-list"><a href="/kr/ko_kr/w/men/ap"
											data-click-area="GNB" data-click-name="MEN_의류_의류 전체">의류
												전체</a></li>
										<li class="threedepth-list"><a
											href="/kr/ko_kr/w/men/ap/hoodies-crews" data-click-area="GNB"
											data-click-name="MEN_의류_후디 &amp; 크루">후디 &amp; 크루</a></li>
										<li class="threedepth-list"><a
											href="/kr/ko_kr/w/men/ap/jackets-vests" data-click-area="GNB"
											data-click-name="MEN_의류_아우터웨어">아우터웨어</a></li>
										<li class="threedepth-list"><a
											href="/kr/ko_kr/w/men/ap/pants-tights" data-click-area="GNB"
											data-click-name="MEN_의류_팬츠 &amp; 타이츠">팬츠 &amp; 타이츠</a></li>
										<li class="threedepth-list"><a
