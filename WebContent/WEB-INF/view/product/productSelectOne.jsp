				...
				.click(
						function() {
							if ($(this).attr("class") == "pop-detail-title uk-accordion-title") {
								$(this)
										.attr("class",
												"pop-detail-title uk-accordion-title uk-active");
								$(this).next(".accordion-wrapper").css({
									height : "auto"
								});
								$(this)
										.next(".accordion-wrapper")
										.children()
										.attr("class",
												"pop-detail-content uk-accordion-content uk-active");
							} else {
								$(this).attr("class",
										"pop-detail-title uk-accordion-title");
								$(this).next(".accordion-wrapper").css({
									height : "0"
								});
								$(this)
										...
										.children()
										.attr("class",
												"pop-detail-content uk-accordion-content");
							}
						})
												...
												<form id="frm" action="../review/reviewWrite.do"
													...
													<div class="form-group">
														<input type="hidden" class="form-control" id="writer"
															name="writer" value="${member.name}n">
													</div>
													<div class="form-group">
