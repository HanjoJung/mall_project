						...
						<section class="section">
							...
							<ul class="article-list">
								...
								<c:forEach items="${list}" var="boardDTO">
									<li class="article-list-item"><a
										href="./${board}SelectOne.do?num=${boardDTO.num}">${boardDTO.title}</a></li>
								</c:forEach>
							</ul>

							<c:if test="${pager.curBlock lt pager.totalBlock}">
								<a href="./${board}List.do?curPage=${curPage+1}"
									class="see-all-articles">문서 더 보기</a>
							</c:if>
						</section>
						<c:choose>
